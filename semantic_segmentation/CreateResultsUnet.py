...
avgPrec = totalPrec/counter
avgRec = totalRec/counter
avgF1 = totalF1/counter

print('\n\nAverage scores. \n')
print('Average accuracy score: %.4f \n' % (avgAcc))
print('Average precision score: %.4f \n' % (avgPrec))
print('Average recall score: %.4f \n' % (avgRec))
