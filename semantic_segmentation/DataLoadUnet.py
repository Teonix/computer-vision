...
# Dataset link: https://www.kaggle.com/jakeshbohaju/brain-tumor?select=Brain+Tumor
...
imgFormatType2WorkWithInput = ('JPG', 'jpg')
imgFormatType2WorkWithOutput = ('JPG', 'jpg') #define the possible types you work with
...
print(' .. warning: Number of images without Brain Tumor cases that had to be excluded were:', NotUsedImagesCounter)
